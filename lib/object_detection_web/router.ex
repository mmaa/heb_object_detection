defmodule ObjectDetectionWeb.Router do
  use ObjectDetectionWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ObjectDetectionWeb.Layouts, :root}
  ...
  if Application.compile_env(:object_detection, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ObjectDetectionWeb.Telemetry
